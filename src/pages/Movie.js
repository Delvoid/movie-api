...
const Movie = () => {
  ...
  return (
    <div className="container mx-auto pc-4">
      <div className="movie-details border-b border-gray-800 pb-12 flex flex-col lg:flex-row">
        ...
        <div className="lg:ml-12 lg:mr-64">
          <h2 className="font-semitbold text-4xl leading-tight mt-1">
            Movie Name
          </h2>
          ...
          <div className="flex flex-wrap items-center mt-8">
            <div className="flex items-center">
              {/* <div id="memberRating" className="w-16 h-16 bg-gray-800 rounded-full relative text-sm">
                            @push('scripts')
            ...
            <div className="flex items-center ml-12">
              <div
                id="criticRating"
                className="w-16 h-16 bg-gray-800 rounded-full relative text-sm"
              >
                {/* @push('scripts')
                                @include('partials/_rating', [
                                    'slug' => 'criticRating',
            ...
            <div className="flex items-center space-x-4 mt-4 lg:mt-0 lg:ml-12">
              ...
              {/* @if ($game['social']['website'])
                            <div className="w-8 h-8 bg-gray-800 rounded-full flex justify-center items-center">
                                <a href="{{ $game['social']['website']['url'] }}" className="hover:text-gray-400">
          ...
          <div className="mt-12" x-data="{ isTrailerModalVisible: false }">
            ...
            <a
              href="#trailer"
              className="inline-flex bg-blue-500 text-white font-semibold px-4 py-4 hover:bg-blue-600 rounded transition ease-in-out duration-150"
            />
            <svg className="w-6 fill-current" viewBox="0 0 24 24">
              <path d="M0 0h24v24H0z" fill="none"></path>
              <path d="M10 16.5l6-4.5-6-4.5v9zM12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8z"></path>
